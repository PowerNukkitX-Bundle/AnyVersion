...
public class MonsterEggTransformer extends ItemDataTransformer {
    ...
    public ItemData transform(ItemData original) {
        ...
        int damage = switch (map.getString("identifier")) {
            case INFESTED_COBBLESTONE -> 1;
            case INFESTED_STONE_BRICKS -> 2;
            case INFESTED_MOSSY_STONE_BRICKS -> 3;
            case INFESTED_CRACKED_STONE_BRICKS -> 4;
            case INFESTED_CHISELED_STONE_BRICKS -> 5;
            default -> 0;
        };
        SimpleItemDefinition itemDefinition = new SimpleItemDefinition(originalItemDefinition.getIdentifier(), 97, originalItemDefinition.getVersion(), originalItemDefinition.isComponentBased(), originalItemDefinition.getComponentData());
