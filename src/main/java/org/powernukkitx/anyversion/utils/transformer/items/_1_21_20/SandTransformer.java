...
public class SandTransformer extends ItemDataTransformer {
    ...
    public ItemData transform(ItemData original) {
        ...
        int damage = map.isEmpty() || map.getString("sand_type").isEmpty() ? 0 : SandType.valueOf(map.getString("sand_type").toUpperCase()).ordinal();
