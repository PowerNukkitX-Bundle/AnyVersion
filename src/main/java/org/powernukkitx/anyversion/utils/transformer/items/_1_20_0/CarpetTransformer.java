package org.powernukkitx.anyversion.utils.transformer.items._1_20_0;
...
import static org.powernukkitx.block.BlockID.WHITE_CARPET;

public class CarpetTransformer extends ItemDataTransformer {
    ...
    public ItemData transform(ItemData original) {
        ...
        SimpleItemDefinition itemDefinition = new SimpleItemDefinition(originalItemDefinition.getIdentifier(), Registries.ITEM_RUNTIMEID.get(WHITE_CARPET), originalItemDefinition.getVersion(), originalItemDefinition.isComponentBased(), originalItemDefinition.getComponentData());
