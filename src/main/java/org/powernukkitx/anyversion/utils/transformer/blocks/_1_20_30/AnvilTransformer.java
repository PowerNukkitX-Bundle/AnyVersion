...
public class AnvilTransformer extends BlockStateTransformer {
    ...
    public BlockState transform(BlockState original) {
        BlockProperties PROPERTIES = new BlockProperties(original.getIdentifier(), CommonBlockProperties.DIRECTION, CommonBlockProperties.DAMAGE);
        ...
        return PROPERTIES.getBlockState(
                ...
                CommonBlockProperties.DAMAGE.createValue(original.getPropertyValue(CommonBlockProperties.DAMAGE))
        );
    }
}
