...
public class StoneBlockSlab2Transformer extends BlockStateTransformer {
    ...
    public BlockState transform(BlockState original) {
        BlockProperties PROPERTIES = new BlockProperties(original.getIdentifier(), TOP_SLOT_BIT, CommonBlockProperties.STONE_SLAB_TYPE_2);
        return PROPERTIES.getBlockState(
                ...
                CommonBlockProperties.STONE_SLAB_TYPE_2.createValue(original.getPropertyValue(CommonBlockProperties.STONE_SLAB_TYPE_2))
        );
    }
}
