...
public class SandstoneTransformer extends ItemDataTransformer {
    ...
    public ItemData transform(ItemData original) {
        ...
        int damage = map.isEmpty() || map.getString("sand_stone_type").isEmpty() ? 0 : SandStoneType.valueOf(map.getString("sand_stone_type").toUpperCase()).ordinal();
