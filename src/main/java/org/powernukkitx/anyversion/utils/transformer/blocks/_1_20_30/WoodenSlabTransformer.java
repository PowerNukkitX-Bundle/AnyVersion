...
public class WoodenSlabTransformer extends BlockStateTransformer {
    ...
    public BlockState transform(BlockState original) {
        BlockProperties PROPERTIES = new BlockProperties(original.getIdentifier(), TOP_SLOT_BIT, CommonBlockProperties.WOOD_TYPE);
        return PROPERTIES.getBlockState(
                ...
                CommonBlockProperties.WOOD_TYPE.createValue(original.getPropertyValue(CommonBlockProperties.WOOD_TYPE))
        );
    }
}
